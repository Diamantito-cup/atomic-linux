...
local shell = "/home/angelito/.local/src/Brain_Shell"
...
hl.bind("SUPER + X", hl.dsp.exec_cmd("qs ipc -c " .. shell .. " call dashboard-launcher toggle"))
hl.bind("SUPER + G", hl.dsp.exec_cmd("qs ipc -c " .. shell .. " call dashboard-config toggle"))
...
hl.bind("SUPER + F", hl.dsp.exec_cmd("qs ipc -c " .. shell .. " call wallpaper-toggle toggle"))
hl.bind("SUPER + H", hl.dsp.exec_cmd("qs ipc -c " .. shell .. " call clipboard-toggle toggle"))
...
hl.bind("SUPER + O", hl.dsp.exec_cmd("qs ipc -c " .. shell .. " call audioMix-toggle toggle"))
